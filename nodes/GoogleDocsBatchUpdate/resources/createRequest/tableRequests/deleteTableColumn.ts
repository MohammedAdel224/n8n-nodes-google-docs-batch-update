...
export const createDeleteTableColumnRequest = (input: IExecuteFunctions, itemIndex: number): IDeleteTableColumnRequest => {
...
const deleteTableColumnRequest: RequestDefinition = {
    ...
    operation: wrapInRequest(createDeleteTableColumnRequest),
};
